...
<body>
    ...
    <form action="update_book_name.php" method="post">
        ...
        <input type="text" id="newName" name="new_book_name" placeholder="Enter New Book Name" required>
        <input type="submit" id="updateName" value="UPDATE BOOK NAME">
    </form>
