...
<body>
    ...
    <form action="update_book_price.php" method="post">
        ...
        <input type="number" id="newPrice" name="new_rent_price" placeholder="Enter New Rent Price" required>
        <input type="submit" id="updatePrice" value="UPDATE RENT PRICE">
    </form>
