...
<body>
    ...
    <form action="update_book_copies.php" method="post">
        ...
        <input type="number" id="newCopies" name="new_book_copies" placeholder="Enter New Number of Copies (INCLUSIVE)" required>
        <input type="submit" id="updateCopies" value="UPDATE BOOK COPIES">
    </form>
